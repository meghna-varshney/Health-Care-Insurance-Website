...
@Component({
  selector: "kr-post-hospital",
  templateUrl: "./post-hospital.component.html",
  styleUrls: ["./post-hospital.component.scss"]
})
export class PostHospitalComponent implements OnInit, AfterViewInit {
  constructor() {}
