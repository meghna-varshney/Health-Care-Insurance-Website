    ...
    $(document).ready(function() {
      ...
      $(".confirm_y").click(function() {
        $(".popup-overlay")
          .show()
          .find(".popup-inner")
          .removeClass("bot_active")
          .find(".confirm_box")
          .hide();
        $(".popup-overlay .popupForm").show();
      });

      $(".unsubs_closebtn, .confirm_n").click(function() {
        $(this)
          .parents("body")
          .removeClass("scrollNone");
        $(".popup-overlay")
          .hide()
          .find(".popup-inner")
          .removeClass("bot_active")
