...
@Component({
  selector: "kr-post-plans",
  templateUrl: "./post-plans.component.html",
  styleUrls: ["./post-plans.component.scss"]
})
export class PostPlansComponent implements OnInit, AfterViewInit {
  constructor() {}
